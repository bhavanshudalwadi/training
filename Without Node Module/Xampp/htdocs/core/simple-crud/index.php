...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <nav aria-label="Page navigation" class="d-flex justify-content-between">
                            <div class="row w-100">
                                ...
                                <div class="col-md-6">
                                    <ul class="mt-2 pagination justify-content-end m-0">
                                        <li class="page-item"><a class="page-link <?php echo ($page <= 1)?"disabled":""; ?>" href="<?php echo ($page > 1)?app_url."/index.php?page=".($page-1)."&per_page=".$records_per_page:"#"; ?>">Previous</a></li>
                                        <?php foreach(range(1, $pages) as $p): ?>
                                            <li class="page-item"><a class="page-link" href="<?php echo app_url; ?>/index.php?page=<?php echo $p; ?>&per_page=<?php echo $records_per_page; ?>"><?php echo $p; ?></a></li>
                                        <?php endforeach; ?>
                                        <li class="page-item"><a class="page-link <?php echo ($page >= $pages)?"disabled":""; ?>" href="<?php echo ($page < $pages)?app_url."/index.php?page=".($page+1)."&per_page=".$records_per_page:"#"; ?>">Next</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
    ...
    <script>
        $("#per_page").on('change', function() {
            ...
            window.location.href = `<?php echo app_url; ?>/index.php?page=1&per_page=${per_page}`;
		});
