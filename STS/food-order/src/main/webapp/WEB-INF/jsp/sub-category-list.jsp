...
<head>
    ...
    <title>Sub Category List | Food Order</title>
    <style>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered table_export_wrapper">
                                            ...
                                            <c:forEach items="${subCategories}" var="subCategory">
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a class="btn btn-primary m-l-5" href="/sub-category/edit/${subCategory.id}"><span class="ti-pencil"></span></a>
                                                    	<a class="btn btn-primary m-l-5" href="/sub-category/delete/${subCategory.id}"><span class="ti-trash"></span></a>
                                                    </td>
                                                </tr>
                                             </c:forEach>
                                            </tbody>
