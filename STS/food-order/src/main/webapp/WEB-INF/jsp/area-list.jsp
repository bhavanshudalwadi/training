...
<head>
    ...
    <title>Area List | Food Order</title>
    <style>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered table_export_wrapper">
                                            ...
                                            <c:forEach items="${areas}" var="area">
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a class="btn btn-primary m-l-5" href="/area/edit/${area.id}"><span class="ti-pencil"></span></a>
                                                    	<a class="btn btn-primary m-l-5" href="/area/delete/${area.id}"><span class="ti-trash"></span></a>
                                                    </td>
                                                </tr>
                                             </c:forEach>
                                            </tbody>
