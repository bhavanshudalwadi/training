...
<head>
    ...
    <title>Category List | Food Order</title>
    <style>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered table_export_wrapper">
                                            ...
                                            <c:forEach items="${categories}" var="category">
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<a class="btn btn-primary m-l-5" href="/category/edit/${category.id}"><span class="ti-pencil"></span></a>
                                                    	<a class="btn btn-primary m-l-5" href="/category/delete/${category.id}"><span class="ti-trash"></span></a>
                                                    </td>
                                                </tr>
                                             </c:forEach>
                                            </tbody>
