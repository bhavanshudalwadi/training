                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" name="weight" id="weight" value="<?php echo ($row != null)?$row['weight']:""; ?>"/>
                            </div>
                            <div class="col-md-3">
                                <label for="height" class="form-label">Height (cm)</label>
                                <input type="number" class="form-control" name="height" id="height" value="<?php echo ($row != null)?$row['height']:""; ?>"/>
                            </div>
                            <div class="col-md-3">
